...
GeneSigBreast <- exprSetBreast[c("212628_at", 
"204216_s_at",
"204313_s_at",
"222103_at",
"212984_at",
...
write.csv(GeneSigBreast, file = "GeneSigBreast.csv",row.names=TRUE)

GeneSigOvarian <- exprSetOvarian[c("212628_at", 
"204216_s_at",
"204313_s_at",
"222103_at",
"212984_at",
...
write.csv(GeneSigOvarian, file = "GeneSigOvarian.csv",row.names=TRUE)

NormalBreast <- BreastCancerMeans[c("212628_at", 
"204216_s_at",
"204313_s_at",
"222103_at",
"212984_at",
...
NormalOvarian <- OvarianCancerMeans[c("212628_at", 
"204216_s_at",
"204313_s_at",
"222103_at",
"212984_at",
...
library(survival)
MyData <- read.csv("KMData.csv", header=FALSE, sep=",")
MyData$SurvObj <- with(MyData, Surv(MyData[,1], MyData[,2] == 1))
km.by.level	 <- survfit(SurvObj ~ MyData[,3], data = MyData, conf.type = "log-log")
plot(km.by.level)
plot(km.by.level, conf = F, mark.time = F)
library(rms)
survplot(km.by.level)
